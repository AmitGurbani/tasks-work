<script>
  import { Page, Navbar, Tabbar, TabbarLink, Block, Icon } from "konsta/svelte";
  import {
    DocCheckmarkFill,
    Calendar,
    ClockFill,
...
<Page name="home">
  <!-- Top Navbar -->
  <Navbar title="Tasks Work" />
  <!-- Tabbar -->
  <Tabbar icons={true} class="left-0 bottom-0 fixed">
    <TabbarLink
    ...
    >
      <svelte:fragment slot="icon">
        <Icon>
          <DocCheckmarkFill class="w-7 h-7" />
        </Icon>
      </svelte:fragment>
    </TabbarLink>
    <TabbarLink
